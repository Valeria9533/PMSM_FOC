...
//		pMessageIO = FMSTR_ValueFromBuffer16(&pcm_wRecTotalSmps, pMessageIO);
    pMessageIO = FMSTR_CopyFromBuffer((FMSTR_ADDR)&pcm_wRecTotalSmps, pMessageIO, 2);	 
		
//    pMessageIO = FMSTR_ValueFromBuffer16(&pcm_wRecPostTrigger, pMessageIO);
    pMessageIO = FMSTR_CopyFromBuffer((FMSTR_ADDR)&pcm_wRecPostTrigger, pMessageIO, 2);		
		
//    pMessageIO = FMSTR_ValueFromBuffer16(&pcm_wRecTimeDiv, pMessageIO);
    pMessageIO = FMSTR_CopyFromBuffer((FMSTR_ADDR)&pcm_wRecTimeDiv, pMessageIO, 2);		
